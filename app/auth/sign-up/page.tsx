              ...
              <form onSubmit={handleSignUp}>
                <div className="flex flex-col gap-6">
                  ...
                  <div className="grid gap-2">
                    ...
                    <RadioGroup value={role} onValueChange={(value) => setRole(value as "usuario" | "dueno")}>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="usuario" id="usuario" />
                        <Label htmlFor="usuario" className="font-normal cursor-pointer">
                          Usuario (Reservar canchas)
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="dueno" id="dueno" />
                        <Label htmlFor="dueno" className="font-normal cursor-pointer">
                          Dueño (Gestionar establecimientos)
                        </Label>
                      </div>
                    </RadioGroup>
                  </div>
